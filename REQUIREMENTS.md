...
- [x] Three merge styles in the editor (matching the landing page): Classic split (crisp seam), Soft seam blend (feathered, default), Sides flipped (photos swapped). Style segmented control syncs with the Flip sides button.
